    ...
    var vista = {
        ...
        getButtons: function (obj) {
            ...
            return '<div class="btn-group">'
                    + ((obj.k_id_substatus != 31 && obj.k_id_substatus != 18) ? '<a href="' + app.urlTo('User/trackingDetails?id=' + obj.k_id_onair) + '" class="btn btn-default btn-xs" data-toggle="tooltip" title="Seguimiento"><span class="fa fa-fw fa-history"></span></a>' : '')
