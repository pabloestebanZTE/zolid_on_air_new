...
(
   ...
   n_comentario         varchar(500) default null,
...
(
   ...
   ic_comentarios_cierre varchar(500) default null,
...
alter table avm add constraint fk_avm_technology foreign key (k_id_technology)
      references technology (k_id_technology) on delete restrict on update restrict;

alter table avm add constraint fk_avm_band foreign key (k_id_band)
