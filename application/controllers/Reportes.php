...
class Reportes extends CI_Controller {
    ...
    public function reportOnair() {
        ...
        for ($i = 0; $i < count($res); $i++) {
            ...
            $objPhpExcel->getActiveSheet()->setCellValue("B" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("C" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("D" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("E" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("F" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("G" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("H" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("I" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("J" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("K" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("L" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("M" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("N" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("O" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("P" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("Q" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("R" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("S" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("T" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("U" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("V" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("W" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("X" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("Y" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("Z" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AA" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AB" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AC" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AD" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AE" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AF" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AG" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AH" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AI" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AJ" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AK" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AL" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AM" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AN" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AO" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AP" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AQ" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AR" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AS" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AT" . ($i + 2), $res[$i]->$res[$i]->);
            $objPhpExcel->getActiveSheet()->setCellValue("AU" . ($i + 2), $res[$i]->$res[$i]->);
