...
class TiketRemedyModel extends Model {
    ...
    protected $n_tipo_afectación;
    protected $n_grupo_soporte;
    protected $d_inicio_afectación;
    ...
    public function setNTipoAfectación($n_tipo_afectación) {
        $this->n_tipo_afectación = $n_tipo_afectación;
    }

    public function getNTipoAfectación() {
        return $this->n_tipo_afectación;
    }
    ...
    public function setDInicioAfectación($d_inicio_afectación) {
        $this->d_inicio_afectación = $d_inicio_afectación;
    }

    public function getDInicioAfectación() {
        return $this->d_inicio_afectación;
    }
